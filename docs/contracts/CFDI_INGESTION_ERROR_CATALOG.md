...
| `INGESTION_UPLOAD_ABORTED`         | F1 activo                                     |             408 | no                           | info         | sí                        | La transferencia fue cancelada antes de completarse.         | Iniciar una nueva carga con otra key si se desea continuar.            |
