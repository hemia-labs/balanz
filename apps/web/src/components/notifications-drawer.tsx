  ...
  return (
    ...
    >
      <div className="space-y-2">
        ...
        <Link href={`/${locale}/despachos/${organization.id}/procesos`} className="mt-4 inline-flex min-h-10 items-center font-semibold text-primary hover:underline">Abrir Centro de procesos</Link>
      </div>
    </DetailDrawer>
  );
}
