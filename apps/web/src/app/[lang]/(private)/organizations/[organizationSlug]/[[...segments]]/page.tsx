...
import { clientById, demoData, membershipFor, organizationBySlug } from "@/lib/demo-data";
import { hasCapability, canAccessClient } from "@/lib/permissions";
import { resolveProductRoute } from "@/lib/product-route";

const demoMode = process.env.NEXT_PUBLIC_DEMO_MODE === "true";

export default async function ProductRoutePage({ params }: { params: Promise<{ lang: string; organizationSlug: string; segments?: string[] }> }) {
