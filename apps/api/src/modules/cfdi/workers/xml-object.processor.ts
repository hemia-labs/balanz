...
import type { IngestionJobHandlerResult } from '../../ingestion/workers/ingestion-job.registry';
...
} from './cfdi-worker-persistence.service';

@Injectable()
export class XmlObjectProcessor {
  constructor(
