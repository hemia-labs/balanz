...
@ForeignKey(
  ...
  { name: 'fk_cfdi_payroll_deductions_payroll', onDelete: 'RESTRICT' },
)
@Unique('uq_cfdi_payroll_deductions_scope_id', [
  'organizationId',
  'clientAccountId',
  'legalEntityId',
  'id',
])
@Unique('uq_cfdi_payroll_deductions_parent_ordinal', [
  'organizationId',
  'clientAccountId',
  'legalEntityId',
  'payrollId',
...
@Check('ck_cfdi_payroll_deductions_ordinal', 'ordinal > 0')
@Check('ck_cfdi_payroll_deductions_amounts', 'amount >= 0')
@Index('ix_cfdi_payroll_deductions_parent', [
  'organizationId',
  'payrollId',
  'ordinal',
])
@Entity('cfdi_payroll_deductions')
export class CfdiPayrollDeduction {
  ...
  @Column({ name: 'deduction_type', type: 'varchar', length: 3 })
