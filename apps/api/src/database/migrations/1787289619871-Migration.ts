...
export class Migration1787289619871 implements MigrationInterface {
    name = 'Migration1787289619871'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "auth_factors" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "user_id" uuid NOT NULL, "provider" character varying(40) NOT NULL, "provider_factor_ref" character varying(255) NOT NULL, "factor_type" character varying(24) NOT NULL, "status" "public"."auth_factors_status_enum" NOT NULL, "verified_at" TIMESTAMP WITH TIME ZONE, "last_used_at" TIMESTAMP WITH TIME ZONE, "revoked_at" TIMESTAMP WITH TIME ZONE, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_27ed6cb91570052a8e43ea4eaba" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "idx_auth_factors_user_status" ON "auth_factors"  ("user_id", "status") `);
        await queryRunner.query(`CREATE UNIQUE INDEX "uq_auth_factors_provider_ref" ON "auth_factors"  ("provider", "provider_factor_ref") `);
        ...
        await queryRunner.query(`CREATE TABLE "auth_sessions" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "session_token_hash" character varying(64) NOT NULL, "user_id" uuid NOT NULL, "membership_id" uuid, "organization_id" uuid, "status" "public"."auth_sessions_status_enum" NOT NULL, "mfa_verified_at" TIMESTAMP WITH TIME ZONE, "expires_at" TIMESTAMP WITH TIME ZONE NOT NULL, "last_activity_at" TIMESTAMP WITH TIME ZONE NOT NULL, "ip_address" character varying(45), "user_agent" character varying(512), "revoked_reason" character varying(100), "revoked_at" TIMESTAMP WITH TIME ZONE, "created_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_641507381f32580e8479efc36cd" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."uq_auth_factors_provider_ref"`);
