...
const ACTIVE_PERMISSION_KEYS = [
  'organization.view', 'organization.manage', 'ownership.manage',
  'billing.manage', 'team.view', 'clients.view', 'clients.manage',
  'clients.assign', 'fiscal_entities.view', 'fiscal_entities.manage',
  'fiscal_years.view', 'fiscal_years.manage', 'credentials.manage',
  'sat.download', 'payroll.view', 'cfdi.exclude', 'exceptions.accept',
  'periods.close', 'periods.reopen', 'exports.generate', 'support.authorize',
  'members.manage', 'permissions.manage',
] as const;

const ACCOUNTANT_PERMISSION_KEYS = [
  'organization.view', 'team.view', 'clients.view', 'clients.manage',
  'clients.assign', 'fiscal_entities.view', 'fiscal_entities.manage',
  'fiscal_years.view', 'fiscal_years.manage', 'credentials.manage',
  'sat.download', 'payroll.view', 'cfdi.exclude', 'exceptions.accept',
  'periods.close', 'periods.reopen', 'exports.generate',
] as const;

const COLLABORATOR_PERMISSION_KEYS = [
  'organization.view', 'clients.view', 'fiscal_entities.view',
  'fiscal_years.view',
] as const;
